...
define([], function () 
{
  var returnedModule = function () 
  {
    ...
    * @version 1.0
    */
    this.CircularArc = function(radius, centerX, centerY)
    {
      if( isNaN(radius) )
        radius = 10;
    ...
    this.CircularArc.__name__ = true;
    this.CircularArc.prototype = 
    {
     /**
     ...
     /**
      * Create a new arc from one angle to another angle - use 0 to 2PI to draw a construct a complete circle
      * 
      * @param from : Number - Initial angle in radians - must be in [0,2PI]
      * @param to : Number - Final angle in radians - must be in [0,2PI]
      * 
      * @return Array - Draw stack for the circular arc (sequence of quad Beziers)
      */
