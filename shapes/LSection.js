...
define(['./ShapeConstants', './Polygon'], function (shapeConstModule, PolygonModule) 
{
  var returnedModule = function () 
  {
   ...
   /**
    * LSection is a closed polygonal L-section shape, often used in drafting.  The bounding rectangle completely defines the L-section along
    ...
    * 
    */
    this.LSection = function() 
    {
      PolygonRef.Polygon.call(this);
    }
    
    this.LSection.__name__  = true;
    this.LSection.__super__ = PolygonRef.Polygon;
    this.LSection.prototype = ExtendFrom( PolygonRef.Polygon.prototype,
    {
     /**
      * Create a new L-Section
      * 
      ...
      * 
      * "thickness" - Pixel thickness of the L-section, which must be two or greater (some compensation will be applied if selected thickness causes the section to exceed the bounding rectangle, but a mininum of 2px is always enforced).<br/><br/>
      * shapeConstants.ORIENT - Value should be one of shapeConstants.UP, shapeConstants.DOWN, shapeConstants.LEFT, shapeConstants.RIGHT (invalid entry defaults to shapeConstants.RIGHT)<br/><br/>
      * 
      * 
      ...
      */
      create: function(__left, __top, __right, __bottom, __params, __yDown)
      {
        ...
        this.clear();
	      ...
	      // itself or exceed the bounding-box dimenstions.
	      switch( orient )
	      {
