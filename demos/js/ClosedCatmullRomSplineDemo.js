/*
 * Supporting script for 2D closed Catmull-Rom spline.  Copyright (c) 2014, Jim Armstrong (The Algorithmist).  All Rights Reserved. 
 */
require(['jquery', 
         'bootstrap', 
         'easeljs', 
                  ...
                  )
{
  ...
  // keep the spline closed
  spline.closed(true);
  
  // interpolation points - THESE NEED TO FORM A NATURALLY CLOSED LOOP FOR THE ALGORITHM TO WORK BEST
  var _x = [-5, 1, 4, 0, -4 ];
  var _y = [3, 3, -2, -4, -2 ];
  ...
  function onPageLoaded()
  {
    ...
    p0Marker.create(stage, null, 6, xAxis, axisLength, yAxis, axisHeight);  
    ...
    p1Marker.create(stage, null, 6, xAxis, axisLength, yAxis, axisHeight);  
    ...
    p2Marker.create(stage, null, 6, xAxis, axisLength, yAxis, axisHeight);  
    ...
    p3Marker.create(stage, null, 6, xAxis, axisLength, yAxis, axisHeight);  
    p3Marker.set_x(xAxis, axisLength, _x[3]);
    p3Marker.set_y(yAxis, axisHeight, _y[3]);
    
    spline.addControlPoint(_x[3], _y[3]);
    
    p4Marker = new markerRef.GraphMarker();
    p4Marker.create(stage, null, 6, xAxis, axisLength, yAxis, axisHeight);  
    p4Marker.set_x(xAxis, axisLength, _x[4]);
    p4Marker.set_y(yAxis, axisHeight, _y[4]);
    
    spline.addControlPoint(_x[4], _y[4]);
