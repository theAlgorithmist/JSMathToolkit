...
require(['jquery', 
         ...
         function($,                       // jQuery
                  ...
                  CubicBezierSplineModule, // CubicBezierSpline
                  ...
                  )
{
  ...
  var cubicSplineRef = new CubicBezierSplineModule();
  var cubicSpline    = new cubicSplineRef.CubicBezierSpline();
  ...
  function onPageLoaded()
  {
    ...
    // Cubic Bezier Spline (default tangent construction)
    var splineRef = new CubicBezierSplineModule();
    spline = new splineRef.CubicBezierSpline();
