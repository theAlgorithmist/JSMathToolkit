/*
 * Supporting script for 2D interactive, cubic Bezier demo with t-at-arc length.  Copyright (c) 2014, Jim Armstrong (The Algorithmist).  All Rights Reserved. 
 */
require(['jquery', 
         'bootstrap', 
         'easeljs', 
                  ...
                  )
{
  ...
  $('input[name="sValue"]').click(function()
  {
    ...
    // natural parameter at this normalized arc length
    var t = curve.tAtLength(s);
    $('#instruct').text( "s = " + s + ", t = " + t.toFixed(2) );
  });
  ...
  $('#reset').click(function()
  {
    ...
    $('#instruct').text("Drag the circular Markers to change cubic control points and adjust the numerical stepper to visualize natural parameter at fraction of arc length.");
  });
