...
require(['jquery', 
         ...
         function($,                    // jQuery
                  ...
                  MotionModule,         // Motion
                  ControllerModule      // WindController
                  )
{
  var stage;
  var xAxis;
  ...
  var __controller = new controllerRef.WindController();
  ...
  $('#begin').click(function()
  {
    ...
    __controller.set_motionParams( {x0:0, y0:0, x1:1, y1:1, v:10, x0w:p0x, y0w:p0y, x1w:p1x, y1w:p1y, w:s, f:0.5, k:0.1} );
  ...
  function onPageLoaded()
  {
    ...
    p0Marker.create(stage, onP0Moved, 6, xAxis, axisLength, yAxis, axisHeight, 0, 255, 0);  
    p0Marker.set_x(xAxis, axisLength, -5);
    p0Marker.set_y(yAxis, axisHeight, -3);
