/*
 * Supporting script for 2D interactive, circle-line segment intersection demo.  Copyright (c) 2014, Jim Armstrong (The Algorithmist).  All Rights Reserved. 
 */
require(['jquery', 
         'bootstrap', 
         'easeljs', 
                  ...
                  )
{
  ...
  var ax, ay;  // P0 coordinates
  var bx, by;  // P1 coordinates
  ...
  function draw()
  {
    var points = __circleUtils.circleSegmentIntersection( ax, ay, bx, by, cx, cy, radius );
   
    var g = drawingShape.graphics;
    g.clear();
    
    // convert graph coordinates to px
    var axPx = (ax - defaultLeft)*pxPerUnitX;
    var ayPx = (defaultTop - ay)*pxPerUnitY;
    
    var bxPx = (bx - defaultLeft)*pxPerUnitX;
    var byPx = (defaultTop - by)*pxPerUnitY;
    
    var cxPx = (cx - defaultLeft)*pxPerUnitX;
    var cyPx = (defaultTop - cy)*pxPerUnitY;
    ...
    $('#instruct').text( "intersection points: " + len );
  };
