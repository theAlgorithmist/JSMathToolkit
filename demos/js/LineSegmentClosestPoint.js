/*
 * Supporting script for 2D distance from point to line segment. Copyright (c) 2014, Jim Armstrong (The Algorithmist).  All Rights Reserved. 
 */
require(['jquery', 
         'bootstrap', 
         'easeljs', 
                  ...
                  )
{
  ...
  function drawLines()
  {
    var point = geomUtils.projectToSegment( p0x, p0y, p1x, p1y, p2x, p2y );
    ...
    var x  = (point.x - defaultLeft)*pxPerUnitX;
    var y  = (defaultTop - point.y)*pxPerUnitY;
