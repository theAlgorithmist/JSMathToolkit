/*
 * Supporting script for 2D gravity controller. Copyright (c) 2014, Jim Armstrong (The Algorithmist).  All Rights Reserved. 
 */
require(['jquery', 
         'bootstrap', 
         'easeljs', 
         ...
         '../../simplePhysics/GravityController'
         ], 
         function($,                    // jQuery
                  ...
                  )
{
  ...
  var __controller = new controllerRef.GravityController();
  ...
  $('#begin').click(function()
  {
    ...
    // use 0.5 graph unit = 1 meter
    __controller.set_motionParams( {x0:p0x, y0:p0y, x1:p1x, y1:p1y, v:s, f:0.5} );
