/*
 * Supporting script for 2D constant motion (velocity and acceleration). Copyright (c) 2014, Jim Armstrong (The Algorithmist).  All Rights Reserved. 
 */
require(['jquery', 
         'bootstrap', 
         'easeljs', 
         ...
         '../../simplePhysics/ConstantMotionController'
         ], 
         function($,                    // jQuery
                  ...
                  MotionModule,         // Motion
                  ControllerModule      // ConstantMotionController
                  )
{
  var stage;
  var xAxis;
  ...
  var __controller = new controllerRef.ConstantMotionController();
  ...
  $('#reset').click(function()
  {
    ...
    p1Marker.set_y(yAxis, axisHeight, 1);
  ...
  $('#begin').click(function()
  {
    ...
    var accelInput = $('input[name="accel"]');
    var a          = accelInput.val();
    
    // you can set this on the controller as initial position or on the motion object
    __motion.set_position(-9,-4);
    
    __controller.set_motionParams( {x0:p0x, y0:p0y, x1:p1x, y1:p1y, v:s, a:a} );
